#!/bin/bash
#SBATCH -A AST211
#SBATCH -J sph_temp158
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -c 32
#SBATCH -t 01:00:00
#SBATCH -p batch
#SBATCH -o output/sph_temp_snap158_%j.out
#SBATCH -e output/sph_temp_snap158_%j.err
...
python python/plotter.py \
    --input  "$OUTDIR/temperature.h5" \
    --output "$OUTDIR/gas_temperature.png" \
    --field gas_temperature_mw \
    --cmap inferno --bare
