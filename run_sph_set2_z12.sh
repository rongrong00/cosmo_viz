...
#SBATCH -t 01:30:00
#SBATCH -p batch
#SBATCH -o output/sph_set2_z12_%j.out
#SBATCH -e output/sph_set2_z12_%j.err
...
SNAP=/lustre/orion/ast211/proj-shared/EDE_Final/finalTest/50cMpc_2/output/snapdir_038/snap_038
REGION=config/zoom_region_10mpc.yaml
CAMERA=config/sph_cam_4k.yaml
OUTDIR=output/sph_set2_z12
